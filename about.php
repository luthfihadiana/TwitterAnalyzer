...
.bgimg-1 {
  background-image: url("bis.jpeg");
  min-height: 100%;
}

.bgimg-2 {
  background-image: url("Rifo.jpg");
  min-height: 400px;
}

.bgimg-3 {
  background-image: url("Upi.jpg");
  min-height: 400px;
}
.bgimg-4 {
  background-image: url("Upi-1.jpg");
  min-height: 400px;
}
...
<div style="color: #777;background-color:white;text-align:center;padding:50px 80px;text-align: justify;">
  <h3 style="text-align:center;">Twitter Analyze</h3>
...
<div class="bgimg-2">
  <div class="caption">
    <span class="border" style="background-color:transparent;font-size:25px;color: #f7f7f7;">Anggota LDR</span>
  </div>
</div>
...
<div style="position:relative;">
    <div style="color:#ddd;background-color:#282E34;text-align:center;padding:50px 80px;text-align: justify;">
        <p>Luthfi Ahmad MH -13516051- Seorang programmer yang mencari jati dirinya </p>
    </div>
</div>
<div class="bgimg-2">
    <div class="caption">
...
<div style="position:relative;">
    <div style="color:#ddd;background-color:#282E34;text-align:center;padding:50px 80px;text-align: justify;">
        <p>Dimas Aditia Pratikto -13516153- Seorang pemain divisi humas terbaik.</p>
    </div>
</div>
<div class="bgimg-1">
  <div class="caption">
